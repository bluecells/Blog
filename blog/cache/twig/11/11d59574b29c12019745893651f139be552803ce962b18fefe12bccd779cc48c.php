...
class __TwigTemplate_222cf0df761e25b1f06659fd728f2be7dac7aff991844bd9d2b485ca648db483 extends \Twig\Template
{
    ...
    {
        return new Source("[New Comment] from {{ form.value.name|e }}", "@Var:[New Comment] from {{ form.value.name|e }}", "");
    }
}
