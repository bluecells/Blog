...
class __TwigTemplate_c27a951fb81953f594c6410673416ce5022acbe5ea127c8e0cb2452ec5f82f39 extends \Twig\Template
{
    ...
    <h3>";
            // line 4
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, "PLUGIN_COMMENTS.ADD_COMMENT"), "html", null, true);
            echo "</h3>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                ...
                if (($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", []), "login", []), "enabled", []) && $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", []), "authenticated", []))) {
                    ...
                    if (($this->getAttribute($context["field"], "name", []) == "name")) {
                        ...
                        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->fieldNameFilter((($context["scope"] ?? null) . $this->getAttribute($context["field"], "name", []))), "html", null, true);
                        echo "\" value=\"";
...
$context["field"], "name", []) == "email")) {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["button"]) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, _twig_default_filter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, $this->getAttribute($context["button"], "value", [])), "Submit"), "html", null, true);
                echo "</button>
        ";
            }
            $_parent = $context['_parent'];
    ...
    ";
        ...
        <h3>";
                // line 46
                echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, "PLUGIN_COMMENTS.COMMENTS"), "html", null, true);
                echo "</h3>
        ...
        <table>
            ";
                ...
                <td>
                    ...
                    ";
                    // line 54
                    echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, "PLUGIN_COMMENTS.WRITTEN_ON"), "html", null, true);
                    echo " ";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["comment"], "date", []));
                    echo " ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, "PLUGIN_COMMENTS.BY"), "html", null, true);
                    echo " ";
    ...
    {% endif %}
{% endif %}
", "partials/comments.html.twig", "/home/boje2508/public_html/yoursafety.training/blog/user/plugins/comments/templates/partials/comments.html.twig");
    }
}
